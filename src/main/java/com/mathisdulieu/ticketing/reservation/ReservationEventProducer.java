...
public class ReservationEventProducer {
    ...
    private static final String RESERVATION_CREATED_TOPIC = "json_realtime_reservation_created";
    private static final String RESERVATION_CANCELLED_TOPIC = "json_realtime_reservation_cancelled";
